...
HELP_STRINGS = """
<code> Hey there! My name is </code>*{}*.
<code> I can help admins manage their groups with Your Love❣️! Have a look at the following for an idea of some of the things I can help you with.
*Main* commands available:</code>
 • /help: <code> PM's you this message.</code>
 • /help <module name>: <code>PM's you info about that module.</code>
 • /donate: <code>information on how to donate!</code>
{}
...
SAITAMA_IMG = "https://telegra.ph/file/8f106f7f1a7f031088a2c.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
Supporting him; [Hero](t.me/slogan_98)"""
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [
                         InlineKeyboardButton(
                             text="Support Group",
                             url=f"https://t.me/Deva_support"),
                         InlineKeyboardButton(
                             text="📘 Logs",
                             url="https://t.me/Deva_logs")
                     ],
                     [
                         InlineKeyboardButton(
                             text="☑️ Source code",
                             url="https://www.google.com/search?q=ente+kayyil+onnula")
                     ]]))
    else:
